...
import { LayoutDashboard, Users, Image, ShoppingCart, Settings, LogOut, Home, LayoutGrid, FolderOpen } from "lucide-react"
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 shadow-sm z-50">
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">{t("management")}</p>
        </div>
